Feature: Verify user is able to untoggle allow friend to view your Disney Pass Photos from Friends and Family request list

  @TestCaseKey=Disney_PassPhotos
  Scenario Outline:Verify user is able to untoggle allow friend to view your Disney Pass Photos from Friends and Family request list
    ...
    And untoggle Allow friend to view your Disney pass Photos
    And click save
