Feature: Verify user is able to connect my profiles from Friends and Family request list

  @TestCaseKey=Disney_ConnectingProfiles
  Scenario Outline:Verify user is able to connect my profiles from Friends and Family request list
