Feature: Validate non Florida account : Florida resident validation with non Florida account

  @TestCaseKey=NonFloridaAccount
  Scenario: Florida resident validation with non Florida account
    ...
    And verify the element is displayed
