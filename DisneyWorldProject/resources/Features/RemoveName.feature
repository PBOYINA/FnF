Feature: Verify user is able to remove name from Friends and Family request list

  @TestCaseKey=Disney_RemoveName
  Scenario Outline: Verify user is able to remove name from Friends and Family request list
