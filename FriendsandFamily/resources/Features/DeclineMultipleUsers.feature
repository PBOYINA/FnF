Feature: Verify user is able to Decline multiple users Friends and Family request

  @TestCaseKey=Decline_Multiple_Users
  Scenario Outline: Verify user is able to Decline multiple users Friends and Family request
