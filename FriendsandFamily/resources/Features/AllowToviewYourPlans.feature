Feature: Verify user is able to untoggle allow friend to view your plans from Friends and Family request list

  @TestCaseKey=Disney_ViewPlans
  Scenario Outline:Verify user is able to untoggle allow friend to view your plans from Friends and Family request list
    ...
    And untoggle Allow friend to view all of your plans
    And click save
